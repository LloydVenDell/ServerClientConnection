...
//------------------------------------------------------------------------------------
  ...
  const String  ButtonColor       = "Module1";
//------------------------------------------------------------------------------------
// LED Delay Variables
//------------------------------------------------------------------------------------
  int           LEDState          = LOW;
...
//====================================================================================
  ...
  void setup() 
  {
    ...
    WiFi.begin("GALILEO", "");      // The SSID That We Want To Connect To
    ...
    if((millis() - LastDebounceTime) > DebounceDelay)
    {
      if(reading != ButtonState)
      {
        ...
        if(ButtonState == LOW)
        {
          ...
          Serial.println("<" + ButtonColor + "-signal received>");
          TKDClient.println("<" + ButtonColor + "-signal received>");
          TKDClient.flush();
        }
      }
    }
